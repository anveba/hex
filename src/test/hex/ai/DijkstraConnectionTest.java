...
public class DijkstraConnectionTest {
    ...
    public void connectorConnectsAgentColouredTilesWithZeroWeight(){
        ...
        Board b = new Board(5);
        b.setTileAtPosition(new Tile(TileColour.PLAYER2), 1,1);
        b.setTileAtPosition(new Tile(TileColour.PLAYER2), 1,2);
        GridGraph g = new GridGraph(5);
        DijkstraBasedTileConnector d = new DijkstraBasedTileConnector();

        d.connectTiles(g,b,1,1,1,2,TileColour.PLAYER2);
    ...
    public void connectorDoesNotConnectNonAgentColouredTiles(){
        ...
        Board b = new Board(5);
        b.setTileAtPosition(new Tile(TileColour.PLAYER1), 1,1);
        b.setTileAtPosition(new Tile(TileColour.PLAYER1), 1,2);
        b.setTileAtPosition(new Tile(TileColour.PLAYER1), 1,3);
        ...
        d.connectTiles(g,b,1,1,1,2,TileColour.PLAYER2);
        d.connectTiles(g,b,1,3,1,4,TileColour.PLAYER2);
        d.connectTiles(g,b,1,3,1,0,TileColour.PLAYER2);
    ...
    public void connectorConnectsPartiallyWhiteTilesWithGreaterThanZeroWeight(){
        ...
        d.connectTiles(g,b,1,1,1,2,TileColour.PLAYER2);
        d.connectTiles(g,b,1,2,1,3,TileColour.PLAYER2);
