...
public class Renderer2D {
    ...
    private static Shader renderer2DShader = null;

    private static Shader getRenderer2DShader() {
        if (renderer2DShader == null) {
            renderer2DShader = new Shader("res/shaders/renderer2D_vertex.glsl", "res/shaders/renderer2D_fragment.glsl");
        }
        return renderer2DShader;
    }
    ...
    public void draw(Texture tex, float x, float y, float width, float height, int sourceX, int sourceY,
        ...
        getRenderer2DShader().use();

        tex.use(0);
        getRenderer2DShader().setInt("u_tex", 0);
